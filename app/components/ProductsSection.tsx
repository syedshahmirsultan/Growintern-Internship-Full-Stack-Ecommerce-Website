...
const ProductsSection = () => {
    return (
        //Margin hatha laini hai jab laptop ki functionaity theek hojaye gi
        <section className='-mt-28 md:mt-80 w-full  dark:bg-slate-900 bg-white'>
            <div className=" w-full  md:max-w-7xl h-[300px] mx-auto md:h-[1000px] flex flex-col">
