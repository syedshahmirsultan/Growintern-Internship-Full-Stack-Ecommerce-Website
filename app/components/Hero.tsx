        ...
        <section className='w-full h-[600px] relative overflow-hidden'>
            {imagesUrl.map((url, index) => (
                <Image
                    ...
                    width={1000}
                    height={1000}
                    className={`absolute top-0 left-0 w-full object-contain md:object-fill transition-opacity duration-1000 ease-in-out ${index === currentImageIndex ? 'opacity-100' : 'opacity-0'}`}
                    priority
                />
            ))}
